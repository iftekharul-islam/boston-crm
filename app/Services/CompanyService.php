...
class CompanyService {
     ...
     * @return $this
     */
    public function createRole( $name = 'admin' ): CompanyService {
        $this->role = Role::query()->create( [ 'name' => $name, 'guard_name' => 'web' ] );
     ...
     * @return void
     */
    public function sendMailToUser( $password ) {
        Notification::route( 'mail',
            $this->user->email )->notify( new CompanyNewUserCreateNotification( name: $this->user->name,
