                    ...
                    <div class="row personal-info">
                        ...
                        <div class="col-lg-6 mb-3 right">
                            ...
                            <div class="personal-info__group">
                                ...
                                <span>:</span>
                                <p class="right-side"><a @if(isset($client->getMedia('clients')[0])) target="_blank" @endif href="{{ isset($client->getMedia('clients')[0]) ? $client->getMedia('clients')[0]->getFullUrl() : '#' }}">Instruction File</a></p>
                            </div>
{{--                            <div class="personal-info__group">--}}
