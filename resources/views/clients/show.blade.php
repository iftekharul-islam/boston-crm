                    ...
                    <div class="row personal-info">
                        ...
                        <div class="col-lg-6 mb-3 right">
                            ...
                            <div class="personal-info__group">
                                ...
                                <p class="right-side">
                                    <a
                                        download="instruction_file"
                                        @if(isset($client->getMedia('clients')[0]))
                                            target="_blank"
                                        @else
                                            style="color: dimgray !important;cursor: default !important;"
                                        @endif
                                            href="{{ isset($client->getMedia('clients')[0]) ? $client->getMedia('clients')[0]->getFullUrl() : '#' }}">
                                        @if(isset($client->getMedia('clients')[0]))
                                            Instruction File
                                        @else
                                            No File
