                    ...
                    <div class="col-lg-8 left mb-3">
                        <div class="d-flex box justify-content-between left__wrap">
                            <div class="left-side max-w-424 w-100 me-3">
                                <div class="group">
                                    ...
                                    <div class="position-relative">
                                        <select name="client_type" id="client-type" class="dashboard-input w-100"
                                            ...
                                            <option value="amc" {{ (old("client_type")=='amc' ? "selected" :"") }}>Amc
                                            </option>
                                            <option value="lender" {{ (old("client_type")=='lender' ? "selected" :"")
                                                }}>Lender</option>
                                            <option value="both" {{ (old("client_type")=='both' ? "selected" :"") }}>
                                                Both</option>
                                        </select>
                                ...
                                <div class="group">
                                    <label for="email" class="d-block mb-2 dashboard-label">Email address <span
                                            class="text-danger require"></span></label>
                                    <input type="email" id="email" name="email[]" class="dashboard-input w-100 mb-3"
                                        required>
                                    <div id="email-append" class="contact-append"></div>
                                    <div class="text-end">
                                        <button id="add-email" class="button button-transparent p-0 text-gray">+ Add
                                            More</button>
                                    </div>
                                </div>
                                <div class="group">
                            ...
                            <div class="right-side max-w-424 w-100">
                                <div class="group">
                                    <label for="address"
                                        class="d-block mb-2 dashboard-label address-label">Address</label>
                                ...
                                <div class="group">
                                    ...
                                    <input type="number" onpaste="return false" min="0"
                                        ...
                                        value="{{ old('processing_fee') }}" class="dashboard-input w-100">
                                </div>
                                <div class="group">
                        ...
                        <div class="box">
                            <div class="max-w-424 w-100">
                                <div class="group">
                                    ...
                                    <input type="number" onpaste="return false" min="0"
                                        onkeypress="return numbersOnly(event)" name="fee_for_1004uad"
                                        value="{{ old('fee_for_1004uad') }}" id="fee-for-1004uad"
                                        class="dashboard-input w-100">
                                </div>
                                <div class="group">
                                    <label for="fee-for-1004d"
                                        class="d-block mb-2 dashboard-label fee-for-1004d-label">Technology fee for
                                        appraisal like 1004D</label>
                                    <input type="number" onpaste="return false" min="0"
                                        onkeypress="return numbersOnly(event)" name="fee_for_1004d"
                                        value="{{ old('fee_for_1004d') }}" id="fee-for-1004d"
                                        class="dashboard-input w-100">
                                </div>
                                <div class="group">
                                    <label for="deducts-technology-fee"
                                        class="d-block mb-2 dashboard-label deducts-technology-fee-label">Deduction of
                                        tech fee during payment </label>
                                    <div class="position-relative">
                                        <select name="deducts_technology_fee"
                                            value="{{ old('deducts_technology_fee') }}" id="deducts-technology-fee"
                                            class="dashboard-input w-100">
                                            <option value="">Choose an option</option>
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                ...
                                <div class="group">
                                    <label for="instruction" class="d-block mb-2 dashboard-label">Requirement
                                        File</label>
