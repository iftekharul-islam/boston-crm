...
<head>
    ...
    <!-- Scripts -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbpvUUlRNGjzvY95IYjt9-rf9FntUcOqc&libraries=places" async
        defer></script>
                    ...
                    <div class="dashboard-header__right d-flex align-items-center">
                        ...
                        <div class="dropdown profile-drop">
                            <div class="profile d-flex align-items-center justify-content-between"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="profile__name">
                                        <p class="text-bold text-light-black fs-14 mb-0 fw-bold name">
                                            {{ Auth::user()->name }}</p>
                                        <p class="text-gray fs-12 mb-0 text-uppercase role">{{ $user_role ?? '' }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <ul class="dropdown-menu profile-dropdown p-0" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item text-light-black" href="{{ route('logout') }}"
