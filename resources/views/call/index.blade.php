            ...
            <div class="call-list">
                ...
                <div class="call-list-header">
                    ...
                    <span class="call-list-item">
                        <div class="dropdown">
                            <svg id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" class="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <div class="checkbox-group">
                                    ...
                                    <label for="" class="checkbox-label">Serial no</label>
                                </div>
                                <div class="checkbox-group">
                                    <input type="checkbox" class="checkbox-input">
                                    <label for="" class="checkbox-label">Due date</label>
                                </div>
                                <div class="checkbox-group">
                                    <input type="checkbox" class="checkbox-input">
                                    <label for="" class="checkbox-label">Serial no</label>
                ...
                <div class="call-item">
                    ...
                    <div class="call-list-body">
                        ...
                        <span class="call-list-item">
                            ...
                            <a href="#" class="icon-list" data-bs-placement="bottom" title="Call log"><span class="icon-messages2 primary-text fs-20" data-bs-toggle="modal" data-bs-target="#callLogModal"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></span></a>
                            ...
                            <a href="#" class="icon-list"  data-bs-placement="bottom" title="Email & SMS"> <span class="icon-messages text-yellow-msg  fs-20" data-bs-toggle="modal" data-bs-target="#sendMesaageModal"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span></a>
                     ...
                     <div class="modal fade schedule-modal call-log-modal" id="callLogModal" tabindex="-1" aria-labelledby="callLogModalLabel" aria-hidden="true">
                        <div class="modal-dialog h-100">
                          <div class="modal-content ">
                            ...
                            <div class="modal-body h-100 overflow-auto">
                              ...
                              <div class="call-summary-item">
                                <div class="top d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1">Mahfuz</p>
                                        <p class="text-gray fs-12 mb-0">Today 12:15 PM</p>
                                    </div>
                                </div>
                                <p class="message">Kmon achen vaiya?</p>
                              </div>
                              <div class="call-summary-item">
                                <div class="top d-flex align-items-center">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpUDTIJ3qyxor41TSNxjJf3jlqk1f6E7gOmA&usqp=CAU" alt=" profile photo boston" class="img-fluid">
                                ...
                                <p class="message">Alhamdulillah vaiya,
                                    kajer obostha khub e valo.
                                    Just r matro koyekta din.</p>
                              </div>
                              <div class="call-summary-item">
                                <div class="top d-flex align-items-center">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpUDTIJ3qyxor41TSNxjJf3jlqk1f6E7gOmA&usqp=CAU" alt=" profile photo boston" class="img-fluid">
                                ...
                                <p class="message">MashaAllah
                                    We are very hapy to hear about 
                                    your update. 
                                    Thanks</p>
                              </div>
                              <div class="call-summary-item">
                              ...
                              <div class="update-log">
                                <p class="mb-3 fw-bold">Update log</p>
                                <textarea name="" id="" cols="30" rows="3" class="dashboard-textarea w-100 br-8" placeholder="Type here..."></textarea>
                            ...
                            <div class="modal-footer">
                              <button type="button" class="button button-primary px-5">Post</button>
                            </div>
                          </div>
                        </div>
                    </div>
                    {{-- Send messages --}}
                    <div class="modal fade schedule-modal call-log-modal" id="sendMesaageModal" tabindex="-1" aria-labelledby="sendMesaageModalLabel" aria-hidden="true">
                        <div class="modal-dialog h-100">
                          <div class="modal-content ">
                            <div class="modal-body h-100 overflow-auto">
                                <p class="mgb-22 fs-20 text-600">Send messages</p>
                               <div class="group">
                                    <label for="" class="d-block mb-1">Receipant email</label>
                                    <input type="text" class="dashboard-input w-100">
                               </div>
                               <div class="group">
                                <label for="" class="d-block mb-1">Mobile no</label>
                                <input type="text" class="dashboard-input w-100">
                               </div>
                               <div class="group">
                                <label for="" class="d-block mb-1">Subject</label>
                                <input type="text" class="dashboard-input w-100">
                               </div>
                               <div class="group">
                                <label for="" class="d-block mb-1">Messages</label>
                                <textarea name="" id="" cols="30" rows="3" class="dashboard-textarea w-100 br-8" placeholder="Type here..."></textarea>
                               </div>
                               <div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="button button-transparent " data-bs-dismiss="modal">Close</button>
                              <button type="button" class="button button-primary px-5">Send</button>
                            </div>
                          </div>
                        </div>
                    </div>
