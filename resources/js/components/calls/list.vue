                    ...
                    <template v-if="orderData.length">
                        <Table :items="orderData" :sl-start="pages.pageData.from" :header="table.header"
                            ...
                            <template v-slot:action="{item}">
                                <a href="javascript:;" class="icon-list" data-bs-placement="bottom" title="Quick view"
                                    @click="openQuickViewFeature(item)"><span class="icon-eye text-blue-eye fs-20"><span
                                            class="path1"></span><span class="path2"></span></span></a>
                                <a href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    title="Quick view" class="icon-list quick-view-icon"><span
                                        class="icon-note text-purple fs-20"><span class="path1"></span><span
                                            class="path2"></span><span class="path3"></span><span
                                            class="path4"></span></span></a>
                                <a href="javascript:;" class="icon-list" data-bs-placement="bottom"
                                    title="Call log"><span class="icon-messages2 primary-text fs-20"><span
                                ...
                                <a href="javascript:;" class="icon-list" data-bs-placement="bottom" title="Email & SMS">
                                    <span class="icon-messages text-yellow-msg  fs-20"><span class="path1"></span><span
                                            class="path2"></span><span class="path3"></span></span></a>
                                <a href="javascript:;" class="icon-list"><span
                                        class="icon-call text-light-red fs-20"><span class="path1"></span><span
                                            class="path2"></span></span></a>
                                <button class="button button-transparent p-0" @click="openIssues(item)"><span
                                        class="icon-arrow-bottom"></span></button>
                            </template>
                            <template v-slot:head_action="{item}">
                                <div class="text-right">
                                    <img src="/icons/column.svg" :tag="item.item"
                                        class="cursor-pointer open-head-column">
                                </div>
                            </template>
