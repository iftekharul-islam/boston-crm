        ...
        <div class="order-add-box bg-white">
            <div class="order-add-box__form">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="step">
                        <button @click="gotoStep(1)" class="step-btn pointer" :class="{'active': step === 1}">Step
                            1</button>
                ...
                <Step1 v-show="step === 1" :type="1" :order="[]" @step-change-active="stepChangeActiveStatus"
                    :order-list-url="orderList" :system-order-no="systemOrderNo" :appraisal-users="appraisalUsers"
                    :appraisal-types="appraisalTypes" :loan-types="loanTypes" :amc-clients="amcClients"
                    :lender-clients="lenderClients" :property-types="propertyTypes" />
                <Step2 v-show="step === 2" :stepData="step1Data" :type="1" :order="[]" />
            </div>
        </div>
    </div>
</template>
